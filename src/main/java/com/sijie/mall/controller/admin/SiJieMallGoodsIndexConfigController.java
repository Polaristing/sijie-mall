...
public class SiJieMallGoodsIndexConfigController {
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(siJieMallIndexConfigService.getConfigsPage(pageUtil));
    }
    ...
    public Result save(@RequestBody IndexConfig indexConfig) {
        ...
        String result = siJieMallIndexConfigService.saveIndexConfig(indexConfig);
    ...
    public Result update(@RequestBody IndexConfig indexConfig) {
        ...
        String result = siJieMallIndexConfigService.updateIndexConfig(indexConfig);
        if (ServiceResultEnum.SUCCESS.getResult().equals(result)) {
            return ResultGenerator.genSuccessResult();
        } else {
            return ResultGenerator.genFailResult(result);
    ...
    public Result info(@PathVariable("id") Long id) {
        IndexConfig config = siJieMallIndexConfigService.getIndexConfigById(id);
        if (config == null) {
    ...
    public Result delete(@RequestBody Long[] ids) {
        ...
        if (siJieMallIndexConfigService.deleteBatch(ids)) {
            return ResultGenerator.genSuccessResult();
        } else {
