...
import com.sijie.mall.dao.MallUserMapper;
...
@Service
public class SiJieMallUserServiceImpl implements SiJieMallUserService {

    @Autowired
    private MallUserMapper mallUserMapper;

    @Override
    public PageResult getSiJieMallUsersPage(PageQueryUtil pageUtil) {
    ...
    public String login(String loginName, String passwordMD5, HttpSession httpSession) {
        ...
        if (user != null && httpSession != null) {
            ...
            SiJieMallUserVO siJieMallUserVO = new SiJieMallUserVO();
            BeanUtil.copyProperties(user, siJieMallUserVO);
            //设置购物车中的数量
            httpSession.setAttribute(Constants.MALL_USER_SESSION_KEY, siJieMallUserVO);
            return ServiceResultEnum.SUCCESS.getResult();
        }
    ...
    @Override
    public SiJieMallUserVO updateUserInfo(MallUser mallUser, HttpSession httpSession) {
